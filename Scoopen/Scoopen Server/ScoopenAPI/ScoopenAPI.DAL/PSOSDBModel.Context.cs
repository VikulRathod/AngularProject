...
namespace ScoopenAPI.DAL
{
    ...
    public partial class PSOSDBContext : DbContext
    {
        public PSOSDBContext()
            : base("name=PSOSDBContext")
        {
        }
        ...
        public virtual DbSet<DeleteFile> DeleteFiles { get; set; }
        ...
        public virtual DbSet<TemplatSearch> TemplatSearches { get; set; }
        public virtual DbSet<tblOrder> tblOrders { get; set; }
        public virtual DbSet<database_firewall_rules> database_firewall_rules { get; set; }
    
        public virtual int searchTemplate()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("searchTemplate");
        }
        ...
        public virtual int spRegisterAdmin(string firstName, string lastName, string email, string password, string phoneNumber, string address, string zipCode)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spRegisterAdmin", firstNameParameter, lastNameParameter, emailParameter, passwordParameter, phoneNumberParameter, addressParameter, zipCodeParameter);
        }
        ...
        public virtual int usp_DeliveryNotification(string delivery_Status)
        {
            var delivery_StatusParameter = delivery_Status != null ?
                new ObjectParameter("Delivery_Status", delivery_Status) :
                new ObjectParameter("Delivery_Status", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_DeliveryNotification", delivery_StatusParameter);
        }
