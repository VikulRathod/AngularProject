...
namespace ScoopenAPI.DAL
{
    ...
    public partial class CHISDBContext : DbContext
    {
        public CHISDBContext()
            : base("name=CHISDBContext")
        {
        }
        ...
        public virtual DbSet<tblAddAgent> tblAddAgents { get; set; }
        public virtual DbSet<tblAddSurgeon> tblAddSurgeons { get; set; }
        ...
        public virtual ObjectResult<f_uspDisplayAgentList_Result> f_uspDisplayAgentList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<f_uspDisplayAgentList_Result>("f_uspDisplayAgentList");
        }
        ...
        public virtual int spAddSurgeon(string firstName, string lastName, string gender, string practiceName, string dateOfBirth, string date, string email, string mobile, string board, string address, string zipCode)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAddSurgeon", firstNameParameter, lastNameParameter, genderParameter, practiceNameParameter, dateOfBirthParameter, dateParameter, emailParameter, mobileParameter, boardParameter, addressParameter, zipCodeParameter);
        }
        ...
        public virtual ObjectResult<spGetSurgeon_Result> spGetSurgeon()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetSurgeon_Result>("spGetSurgeon");
        }
        ...
        public virtual int usp_AddNewAgent(string firstName, string lastName, string gender, string dateOfBirth, string date, string email, string mobile, string address, string zipCode)
        {
            var firstNameParameter = firstName != null ?
                new ObjectParameter("FirstName", firstName) :
                new ObjectParameter("FirstName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_AddNewAgent", firstNameParameter, lastNameParameter, genderParameter, dateOfBirthParameter, dateParameter, emailParameter, mobileParameter, addressParameter, zipCodeParameter);
        }
        ...
        public virtual ObjectResult<usp_ListOfAgent_Result> usp_ListOfAgent()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ListOfAgent_Result>("usp_ListOfAgent");
        }
    
        public virtual ObjectResult<usp_sample_Result> usp_sample()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_sample_Result>("usp_sample");
        }
        ...
        public virtual ObjectResult<uspSurgeonList_Result> uspSurgeonList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspSurgeonList_Result>("uspSurgeonList");
        }
    }
}
